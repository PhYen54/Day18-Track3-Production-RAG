...
- **[01a]** Tên hoạt động sản xuất kinh doanh: Hoạt động kinh doanh thông thường
...
| STT | Chỉ tiêu | Mã chỉ tiêu | Giá trị hàng hóa, dịch vụ (chưa có thuế GTGT) | Mã | Thuế giá trị gia tăng |
|-----|----------|-------------|------------------------------------------------|----|----------------------|
...
| 2 | Hàng hóa, dịch vụ bán ra chịu thuế giá trị gia tăng `([27]=[29]+[30]+[32]+[32a]; [28]=[31]+[33])` | [27] | 3.703.688.610 | [28] | 344.675.400 |
...
| 3 | Tổng doanh thu và thuế giá trị gia tăng của hàng hóa, dịch vụ bán ra `([34]=[26]+[27]; [35]=[28])` | [34] | 3.703.688.610 | [35] | 344.675.400 |
| **III** | **Thuế giá trị gia tăng phát sinh trong kỳ `([36]=[35]-[25])`** | | | [36] | 129.511.633 |
| **IV** | **Điều chỉnh tăng, giảm thuế giá trị gia tăng của các kỳ trước** | | | | |
...
| 1 | Thuế GTGT phải nộp của hoạt động SXKD trong kỳ `{[40a]={[36]-[22]+[37]-[38]-[39a]) ≥ 0}` | | | [40a] | 52.133.830 |
...
|---|---|
| Họ và tên: | *(Chữ ký, ghi rõ họ tên; chức vụ và đóng dấu (nếu có)/Ký điện tử)* |
| Chứng chỉ hành nghề số: | **TRỊNH THỊ SANG** |
